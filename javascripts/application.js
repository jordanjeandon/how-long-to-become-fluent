...
// resultats
	$('#result').on('click' , function () {
		...
		var timelapse = hours/(week * intensity); 
        // nombre de semaine
		...
		var nombreMois = Math.floor(timelapse / 4.3) ; 
        // nombre de mois
		console.log(nombreMois + 'nombreMois');

		var moisRestant = nombreMois % 12 ; 
        // pour connaitre le resultat mois
        ...
        // numero du jour
     	message += mois[date.getMonth() + moisRestant] + " ";   
        // mois
